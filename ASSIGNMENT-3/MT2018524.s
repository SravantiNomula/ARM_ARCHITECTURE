...
__main FUNCTION
	 ...
	 MOV R4,#0;	a1
	 VMOV.F32 S0,R4;			Move A1 tofloating point register
     VCVT.F32.S32 S0,S0; 		      Convert into signed 32bit number

	 MOV R5,#0;	a2	
	 VMOV.F32 S1,R5;			Move A2 to floating point register
     VCVT.F32.S32 S1,S1; 		       Convert into signed 32bit number


	 MOV R6,#1;	a3
	 VMOV.F32 S2,R6;			Move A3 to floating point register
     VCVT.F32.S32 S2,S2; 		       Convert into signed 32bit number


	 MOV R7,#3;	Case selected
